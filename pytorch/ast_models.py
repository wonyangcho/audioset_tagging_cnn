...
class AST(nn.Module):
    ...
    def __init__(self, sample_rate, window_size, hop_size, mel_bins, fmin,
        ...
        if audioset_pretrain == False:
            ...
            self.mlp_head = nn.Sequential(nn.LayerNorm(self.original_embedding_dim), nn.Linear(self.original_embedding_dim, classes_num))
    ...
    def forward(self, input, mixup_lambda=None):
        ...
        # print(f"11. {x.shape} {self.v.pos_embed.shape}")
